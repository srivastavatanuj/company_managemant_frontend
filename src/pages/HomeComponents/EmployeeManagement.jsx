...
const EmployeeManagement = () => {
  return (
    <div className="mt-6 sm:mt-14 mx-4 sm:mx-10 md:mx-20 lg:mx-40">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-items-center mt-8">
        <div className="flex justify-center items-center border-red-200 border-2 h-48 w-48 sm:h-56 sm:w-56 md:h-60 md:w-60 bg-[#e7e0e0] rounded-lg shadow-lg">
