        ...
        <div className='px-10 md:px-20 lg:px-40'>
            <div className='flex flex-col md:flex-row items-center justify-between md:mt-14 mt-5 mb-6 md:mb-14 gap-6'>
                ...
                <div className='text-center md:text-left'>
                    <h2 className="text-2xl md:font-normal  md:text-2xl lg:text-4xl font-semibold mb-4">
                        Employee Self-service
                    </h2>
                    <p className="text-base md:font-normal font-semibold w-full max-w-sm md:text-base lg:text-lg">
