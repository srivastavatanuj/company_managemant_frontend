    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row justify-evenly items-center mt-8 sm:mt-12 md:mt-20">
        <div className="flex flex-col items-center mb-6 sm:mb-0 w-full sm:w-1/2 px-4">
          <img className="w-full h-auto object-cover" src={middleimage1} alt="Secure password management" />
          <div>
            <h1 className="text-center text-base sm:text-lg md:text-xl  mt-2">Secure password management using Zoho Vault</h1>
          </div>
        </div>
        <div className="flex flex-col items-center mb-6 sm:mb-0 w-full sm:w-1/2 px-4">
          <img className="w-full h-auto object-cover" src={middleimage2} alt="Shielded access to employee info" />
          <div>
      ...
      <div className="text-xl sm:text-2xl text-center mt-8 sm:mt-12 md:text-3xl font-semibold">
